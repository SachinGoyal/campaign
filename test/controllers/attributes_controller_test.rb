...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { company_id: @attribute.company_id, description: @attribute.description, name: @attribute.name, status: @attribute.status }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { company_id: @attribute.company_id, description: @attribute.description, name: @attribute.name, status: @attribute.status }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
